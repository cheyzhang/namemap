...
const DEFAULT_WEIGHT = [1, 0, 0]; // Takes data and aggregation params and returns aggregated data.
...
function parseGridData(data, getPosition) {
  ...
  for (const object of iterable) {
    ...
    const weight = getWeight ? getWeight(object, objectInfo) : DEFAULT_WEIGHT; // Aggregator expects each weight is an array of size 3
